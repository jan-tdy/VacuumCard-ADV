  ...
  `}let Ut=class extends lt{constructor(){super(...arguments),this._calibrationPoints=[],this._calibrationSnap90=!0,this._furniture=[],this._furnitureAddType="bed",this._usedDetectedFurnitureIds=new Set}setConfig(t){this._config=t,this._furniture=t.furniture??[]}_fireConfigChanged(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_valueChanged(t,e){this._config[t]!==e&&this._fireConfigChanged({...this._config,[t]:e})}get _cameraId(){if(this._config?.vacuum)return this._config.camera??kt(this.hass,this._config.vacuum).camera}get _roomGeometry(){const t=this._cameraId;if(!t)return;const e=this.hass.states[t]?.attributes?.room_geometry;return e&&e.rooms?.length?e:void 0}render(){return this.hass&&this._config?B`
    ...
    `}_renderCalibrationOverlay(t){const e=this._calibrationRoomId,i=t.rooms.find(t=>t.id===e),r=void 0!==e?Ct(this._config.room_polygons,t)[String(e)]:void 0,s=r&&r.length>=3?W`<polygon
        ...
        ></rect>`:G,n=this._calibrationPoints.length>0?W`
          ...
          `:G;return W`${o}${s}${n}`}_onCalibrationClick(t){const e=t.currentTarget,i=At(t.clientX,t.clientY,e,0);let r=Math.round(i.x),s=Math.round(i.y);if(this._calibrationSnap90&&this._calibrationPoints.length>0){const[t,e]=this._calibrationPoints[this._calibrationPoints.length-1];Math.abs(r-t)>Math.abs(s-e)?s=e:r=t}this._calibrationPoints=[...this._calibrationPoints,[r,s]]}_finishCalibration(){const t=this._roomGeometry;if(void 0===this._calibrationRoomId||this._calibrationPoints.length<3||!t)return;const e={...this._config.room_polygons??{}};e[`${St(t)}:${this._calibrationRoomId}`]=this._calibrationPoints,this._calibrationPoints=[],this._valueChanged("room_polygons",e)}_deleteCalibration(){const t=this._roomGeometry;if(void 0===this._calibrationRoomId||!this._config.room_polygons||!t)return;const e={...this._config.room_polygons};delete e[`${St(t)}:${this._calibrationRoomId}`],delete e[String(this._calibrationRoomId)],this._calibrationPoints=[],this._valueChanged("room_polygons",e)}_visibleFurniture(t){if(!t)return this._furniture;const e=St(t);return this._furniture.filter(t=>!t.map||t.map===e)}_renderFurniture(){const t=this._roomGeometry,e=this._cameraId,i=e?bt(this.hass,e):void 0,r=this._visibleFurniture(t),s=r.find(t=>t.id===this._selectedFurnitureId);return B`
      <div class="section">
