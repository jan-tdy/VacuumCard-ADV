 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function _t(t,e){return(e,i,r)=>((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(e,i,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}const gt=[{name:"Empty Dust Bin",icon:"mdi:delete-empty"},{name:"Wash Mop",icon:"mdi:water-sync"},{name:"Dry Mop",icon:"mdi:tumble-dryer"},{name:"Remove Hair",icon:"mdi:content-cut"}],$t=["cleaning"],vt=["schedules","status"];function yt(t){return t.entities}function bt(t,e){const i=t.states[e],r=i?.attributes?.entity_picture;if(!r)return;if(!i.last_updated)return r;const s=r.includes("?")?"&":"?";return`${r}${s}_hactl=${encodeURIComponent(i.last_updated)}`}function wt(t,e){const i=yt(t)?.[e];if(i?.name)return i.name;if(i?.original_name)return i.original_name;const r=t.states[e],s=r?.attributes?.friendly_name;return"string"==typeof s?s:e}function xt(t,e){return t.filter(t=>t.startsWith(`${e}.`))}function St(t,e){const i=function(t,e){const i=yt(t);if(!i)return[];const r=i[e]?.device_id;return r?Object.keys(i).filter(t=>i[t]?.device_id===r):[]}(t,e),r={dockActions:[],sensors:[],maintenanceSensors:[]};if(0===i.length)return r;r.camera=xt(i,"camera")[0];for(const e of xt(i,"select")){const i=wt(t,e);i.includes("Water Level")?r.waterLevel=e:i.includes("Clean Passes")?r.cleanPasses=e:r.maintenanceSensors.push(e)}for(const e of xt(i,"sensor")){const i=t.states[e];if("battery"===i?.attributes?.device_class){r.battery=e;continue}const s=wt(t,e).toLowerCase();if(s.includes("remaining")||s.includes("carpet"))r.maintenanceSensors.push(e);else{if(vt.some(t=>s.endsWith(t)))continue;r.sensors.push(e)}}for(const e of xt(i,"binary_sensor"))wt(t,e).toLowerCase().includes("mop")?r.mopAttached=e:r.maintenanceSensors.push(e);for(const t of xt(i,"number"))r.maintenanceSensors.push(t);for(const t of xt(i,"switch"))r.maintenanceSensors.push(t);for(const e of xt(i,"button")){const i=wt(t,e),s=gt.find(t=>t.name===i);s&&r.dockActions.push({entityId:e,name:s.name,icon:s.icon})}return r}function kt(t,e,i,r){const s=i.getBoundingClientRect(),o=s.left+s.width/2,n=s.top+s.height/2,a=i.offsetWidth||s.width,c=i.offsetHeight||s.height;let l=t-o,h=e-n;if(r%360!=0){const t=-r*Math.PI/180,e=Math.cos(t),i=Math.sin(t),s=l*i+h*e;l=l*e-h*i,h=s}const d=h+c/2;return{x:(l+a/2)*(i.naturalWidth/a),y:d*(i.naturalHeight/c)}}function At(t){return void 0!==t.map_id&&null!==t.map_id?`map:${t.map_id}`:t.rooms.map(t=>`${t.id}:${t.name}`).sort().join("|")}function Ct(t,e){if(!t)return{};const i=At(e),r={};for(const s of e.rooms){const e=t[`${i}:${s.id}`]??t[String(s.id)];e&&(r[String(s.id)]=e)}return r}function Mt(t,e){return t.x>=e[0]&&t.x<=e[2]&&t.y>=e[1]&&t.y<=e[3]}function Pt(t,e){let i=!1;for(let r=0,s=e.length-1;r<e.length;s=r++){const[o,n]=e[r],[a,c]=e[s];n>t.y!=c>t.y&&t.x<(a-o)*(t.y-n)/(c-n)+o&&(i=!i)}return i}function Et(t,e,i){const r=t.x-e,s=t.y-i;return r*r+s*s}const Rt={brown:{fill:"#bcaaa4",stroke:"#6d4c41",detail:"#8d6e63",line:"#4e342e"},white:{fill:"#fafafa",stroke:"#9e9e9e",detail:"#e0e0e0",line:"#757575"}};function Ft(t){return Rt[t??"brown"]??Rt.brown}const It=[{type:"bed",label:"Bed",icon:"mdi:bed",widthPct:.16,heightPct:.24},{type:"sofa",label:"Sofa",icon:"mdi:sofa",widthPct:.28,heightPct:.11},{type:"table",label:"Table",icon:"mdi:table-furniture",widthPct:.16,heightPct:.1},{type:"desk",label:"Desk",icon:"mdi:desk",widthPct:.16,heightPct:.08},{type:"chair",label:"Chair",icon:"mdi:chair-rolling",widthPct:.07,heightPct:.07},{type:"wardrobe",label:"Wardrobe",icon:"mdi:wardrobe",widthPct:.14,heightPct:.06},{type:"toilet",label:"Toilet",icon:"mdi:toilet",widthPct:.07,heightPct:.09},{type:"sink",label:"Sink",icon:"mdi:sink",widthPct:.07,heightPct:.055},{type:"bathtub",label:"Bathtub",icon:"mdi:bathtub",widthPct:.11,heightPct:.2},{type:"fridge",label:"Fridge",icon:"mdi:fridge-outline",widthPct:.065,heightPct:.065},{type:"washing_machine",label:"Washing Machine",icon:"mdi:washing-machine",widthPct:.065,heightPct:.065},{type:"tv",label:"TV",icon:"mdi:television",widthPct:.14,heightPct:.025},{type:"stairs",label:"Stairs",icon:"mdi:stairs",widthPct:.12,heightPct:.16},{type:"plant",label:"Plant",icon:"mdi:flower",widthPct:.04,heightPct:.04},{type:"custom",label:"Custom",icon:"mdi:shape-outline",widthPct:.09,heightPct:.09}];function Tt(t){return It.find(e=>e.type===t)??It[It.length-1]}function Ot(t){return(t%360+360)%360}function Dt(t,e,i){const r=-e/2,s=-i/2,o=Math.min(e,i);switch(t){case"bed":{const t=.22*i;return W`
      ...
      `;case"tv":return W`<rect x=${r} y=${s} width=${e} height=${i} rx=${.15*i} class="furn-body"></rect>`;case"stairs":{const t=5,o=i/t,n=[];for(let i=1;i<t;i++){const t=s+o*i;n.push(W`<line x1=${r} y1=${t} x2=${r+e} y2=${t} class="furn-line"></line>`)}return W`
        <rect x=${r} y=${s} width=${e} height=${i} class="furn-body"></rect>
        ${n}
      `}case"plant":return W`<circle cx="0" cy="0" r=${o/2} class="furn-body furn-plant"></circle>`;default:return W`<rect x=${r} y=${s} width=${e} height=${i} rx=${.08*o} class="furn-body"></rect>`}}function Nt(t,e,i,r,s){return B`
    <ha-form
      .hass=${t}
      .data=${{value:i}}
  ...
  `}let Ut=class extends lt{constructor(){super(...arguments),this._calibrationPoints=[],this._calibrationSnap90=!0,this._furniture=[],this._furnitureAddType="bed",this._usedDetectedFurnitureIds=new Set}setConfig(t){this._config=t,this._furniture=t.furniture??[]}_fireConfigChanged(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_valueChanged(t,e){this._config[t]!==e&&this._fireConfigChanged({...this._config,[t]:e})}get _cameraId(){if(this._config?.vacuum)return this._config.camera??St(this.hass,this._config.vacuum).camera}get _roomGeometry(){const t=this._cameraId;if(!t)return;const e=this.hass.states[t]?.attributes?.room_geometry;return e&&e.rooms?.length?e:void 0}render(){return this.hass&&this._config?B`
    ...
    `}_renderRotation(){return B`
      <div class="section map-layout">
        ...
        ></ha-textfield>
        ${Nt(this.hass,"Map position",this._config.map_position??"top",[{value:"top",label:"Top (after controls)"},{value:"bottom",label:"Bottom (after battery/sensors)"}],t=>this._valueChanged("map_position",t))}
    ...
    `}_renderCalibration(){const t=this._roomGeometry,e=this._cameraId,i=e?bt(this.hass,e):void 0;return B`
      <div class="section">
        ...
        ${t&&i?B`
              ${Nt(this.hass,"Room to calibrate",void 0!==this._calibrationRoomId?String(this._calibrationRoomId):"",t.rooms.map(t=>({value:String(t.id),label:t.name})),t=>{const e=Number(t),i=Number.isNaN(e)?void 0:e;i!==this._calibrationRoomId&&(this._calibrationRoomId=i,this._calibrationPoints=[])})}
    ...
    `}_renderCalibrationOverlay(t){const e=this._calibrationRoomId,i=t.rooms.find(t=>t.id===e),r=void 0!==e?Ct(this._config.room_polygons,t)[String(e)]:void 0,s=r&&r.length>=3?W`<polygon
        ...
        ></rect>`:G,n=this._calibrationPoints.length>0?W`
          ...
          `:G;return W`${o}${s}${n}`}_onCalibrationClick(t){const e=t.currentTarget,i=kt(t.clientX,t.clientY,e,0);let r=Math.round(i.x),s=Math.round(i.y);if(this._calibrationSnap90&&this._calibrationPoints.length>0){const[t,e]=this._calibrationPoints[this._calibrationPoints.length-1];Math.abs(r-t)>Math.abs(s-e)?s=e:r=t}this._calibrationPoints=[...this._calibrationPoints,[r,s]]}_finishCalibration(){const t=this._roomGeometry;if(void 0===this._calibrationRoomId||this._calibrationPoints.length<3||!t)return;const e={...this._config.room_polygons??{}};e[`${At(t)}:${this._calibrationRoomId}`]=this._calibrationPoints,this._calibrationPoints=[],this._valueChanged("room_polygons",e)}_deleteCalibration(){const t=this._roomGeometry;if(void 0===this._calibrationRoomId||!this._config.room_polygons||!t)return;const e={...this._config.room_polygons};delete e[`${At(t)}:${this._calibrationRoomId}`],delete e[String(this._calibrationRoomId)],this._calibrationPoints=[],this._valueChanged("room_polygons",e)}_visibleFurniture(t){if(!t)return this._furniture;const e=At(t);return this._furniture.filter(t=>!t.map||t.map===e)}_renderFurniture(){const t=this._roomGeometry,e=this._cameraId,i=e?bt(this.hass,e):void 0,r=this._visibleFurniture(t),s=r.find(t=>t.id===this._selectedFurnitureId);return B`
      <div class="section">
        ...
        <div class="furniture-add-row">
          ${Nt(this.hass,"Furniture type",this._furnitureAddType,It.map(t=>({value:t.type,label:t.label})),t=>this._furnitureAddType=t)}
        ...
        ></ha-form>
        ${Nt(this.hass,"Furniture color",this._config.furniture_color??"brown",[{value:"brown",label:"Brown (wood-toned)"},{value:"white",label:"White (light gray)"}],t=>this._valueChanged("furniture_color",t))}
    ...
    `}_renderFurnitureOverlay(t,e){const i=Ft(this._config.furniture_color),r=`--furn-fill:${i.fill};--furn-stroke:${i.stroke};--furn-detail:${i.detail};--furn-line:${i.line};`;return B`
      <svg
    ...
    `}_renderFurnitureToolbar(t){return B`
      <div class="furniture-toolbar">
        <ha-icon icon=${Tt(t.type).icon}></ha-icon>
        <span>${Tt(t.type).label}</span>
    ...
    `}_renderFurnitureList(t){return B`
      <div class="furniture-list">
        ${t.map(t=>{const e=Tt(t.type);return B`
            <div
    ...
    `}_addFurniture(){const t=this._roomGeometry;if(!t)return;const e=function(t,e,i){const r=Tt(t),s=Math.min(e.image_width,e.image_height),o=Math.max(12,Math.round(r.widthPct*s)),n=Math.max(12,Math.round(r.heightPct*s)),a=i.length%6*s*.03;return{id:`furn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,type:t,x:Math.round(e.image_width/2+a),y:Math.round(e.image_height/2+a),width:o,height:n,rotation:0,map:At(e)}}(this._furnitureAddType,t,this._furniture);this._furniture=[...this._furniture,e],this._selectedFurnitureId=e.id,this._commitFurniture()}_addDetectedFurniture(t){const e=this._roomGeometry;if(!e)return;const i=function(t,e,i){const[r,s,o,n]=e.bbox;return{id:`furn_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,type:t,x:Math.round((r+o)/2),y:Math.round((s+n)/2),width:Math.max(12,Math.round(o-r)),height:Math.max(12,Math.round(n-s)),rotation:Ot(e.angle),map:At(i)}}(this._furnitureAddType,t,e);this._furniture=[...this._furniture,i],this._selectedFurnitureId=i.id,this._usedDetectedFurnitureIds=new Set(this._usedDetectedFurnitureIds).add(t.id),this._commitFurniture()}_removeFurniture(t){this._furniture=this._furniture.filter(e=>e.id!==t),this._selectedFurnitureId===t&&(this._selectedFurnitureId=void 0),this._commitFurniture()}_rotateFurniture(t,e){this._furniture=this._furniture.map(i=>i.id===t?{...i,rotation:Ot(i.rotation+e)}:i),this._commitFurniture()}_setFurnitureField(t,e,i){const r=Number(i);if(Number.isNaN(r))return;const s="width"===e||"height"===e?Math.max(12,Math.round(r)):Math.round(r);this._furniture=this._furniture.map(i=>i.id===t?{...i,[e]:s}:i),this._commitFurniture()}_commitFurniture(){this._valueChanged("furniture",this._furniture)}_startFurnitureDrag(t,e,i){t.stopPropagation(),t.preventDefault();const r=this._furnitureImg,s=this._furniture.find(t=>t.id===e);if(!r||!s)return;this._selectedFurnitureId=e;const o=t.currentTarget;o.setPointerCapture(t.pointerId);const n=kt(t.clientX,t.clientY,r,0),a=t=>{const o=kt(t.clientX,t.clientY,r,0);this._applyFurnitureDrag(e,i,s,n,o)},c=()=>{o.removeEventListener("pointermove",a),o.removeEventListener("pointerup",c),o.removeEventListener("pointercancel",c),this._commitFurniture()};o.addEventListener("pointermove",a),o.addEventListener("pointerup",c),o.addEventListener("pointercancel",c)}_applyFurnitureDrag(t,e,i,r,s){this._furniture=this._furniture.map(o=>{if(o.id!==t)return o;if("move"===e)return{...o,x:i.x+(s.x-r.x),y:i.y+(s.y-r.y)};if("rotate"===e){const t=180*Math.atan2(s.y-i.y,s.x-i.x)/Math.PI+90;return{...o,rotation:Math.round(Ot(t))}}const n=-i.rotation*Math.PI/180,a=s.x-i.x,c=s.y-i.y,l=a*Math.cos(n)-c*Math.sin(n),h=a*Math.sin(n)+c*Math.cos(n);return{...o,width:Math.max(12,Math.round(2*Math.abs(l))),height:Math.max(12,Math.round(2*Math.abs(h)))}})}};Ut.styles=n`
    .section {
      display: flex;
  ...
  `,t([ft({attribute:!1})],Ut.prototype,"hass",void 0),t([mt()],Ut.prototype,"_config",void 0),t([mt()],Ut.prototype,"_calibrationRoomId",void 0),t([mt()],Ut.prototype,"_calibrationPoints",void 0),t([mt()],Ut.prototype,"_calibrationSnap90",void 0),t([mt()],Ut.prototype,"_furniture",void 0),t([mt()],Ut.prototype,"_selectedFurnitureId",void 0),t([mt()],Ut.prototype,"_furnitureAddType",void 0),t([_t("img.furniture-image")],Ut.prototype,"_furnitureImg",void 0),t([mt()],Ut.prototype,"_usedDetectedFurnitureIds",void 0),Ut=t([dt("vacuum-card-adv-editor")],Ut),console.info("%c VACUUM-CARD-ADV %c v2.2.0 ","color: #0b0f14; background: #34e0d6; font-weight: 700;","color: #34e0d6; background: #0b0f14; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:"vacuum-card-adv",name:"TapoVac ADV Vacuum Card",description:"A card for the TapoVac-ADV integration (Tapo RV30/RV50 series).",preview:!0});let Ht=class extends lt{constructor(){super(...arguments),this._discovered={dockActions:[],sensors:[],maintenanceSensors:[]},this._selectedRoomIds=new Set,this._maintenanceOpen=!1,this._busy=!1,this._trace=[]}static getConfigElement(){return document.createElement("vacuum-card-adv-editor")}static getStubConfig(t){return{type:"custom:vacuum-card-adv",vacuum:Object.keys(t.states).find(t=>t.startsWith("vacuum."))??"",show_map:!0,show_controls:!0,show_dock_actions:!0,show_fan_speed:!0,show_water_level:!0,show_battery:!0,show_sensors:!0,show_mop_status:!0,show_room_names:!0,show_last_updated:!0,show_furniture:!0,furniture_opacity:100,furniture_color:"brown"}}setConfig(t){if(!t.vacuum)throw new Error("vacuum entity is required");this._config={show_map:!0,show_controls:!0,show_dock_actions:!0,show_fan_speed:!0,show_water_level:!0,show_battery:!0,show_sensors:!0,show_mop_status:!0,show_room_names:!0,show_last_updated:!0,show_furniture:!0,furniture_opacity:100,furniture_color:"brown",map_rotation:0,...t},this._maintenanceOpen=!1===t.maintenance_collapsed_default}getCardSize(){let t=2;return(this._config?.show_map??!0)&&(t+=6),(this._config?.show_sensors??!0)&&(t+=2),t}willUpdate(t){t.has("hass")&&this.hass&&this._config?.vacuum&&(this._lastDiscoveredFor!==this._config.vacuum&&(this._discovered=St(this.hass,this._config.vacuum),this._lastDiscoveredFor=this._config.vacuum),this._updateTrace())}_updateTrace(){const t=this.hass.states[this._config.vacuum]?.state,e=t=>void 0!==t&&$t.includes(t),i=e(t);if(t!==this._lastVacuumStateForTrace&&(i&&!e(this._lastVacuumStateForTrace)&&(this._trace=[]),this._lastVacuumStateForTrace=t),!this._config.show_trace||!i)return;const r=this._roomGeometry?.vacuum_point;if(!r)return;const s=this._trace[this._trace.length-1];if(s&&s[0]===r[0]&&s[1]===r[1])return;const o=[...this._trace,r];this._trace=o.length>400?o.slice(o.length-400):o}get _roomGeometry(){const t=this._config.camera??this._discovered.camera;if(!t)return;const e=this.hass.states[t],i=e?.attributes?.room_geometry;return i&&i.rooms?i:void 0}_shortTitle(t){const e=this.hass.states[this._config.vacuum],i=e?.attributes.friendly_name;return i&&t.startsWith(`${i} `)?t.slice(i.length+1):t}_lastUpdated(){const t=[this._config.vacuum,this._config.battery_entity??this._discovered.battery,this._config.mop_attached_entity??this._discovered.mopAttached,...this._config.sensors??this._discovered.sensors].filter(t=>!!t);let e;for(const i of t){const t=this.hass.states[i]?.last_changed;if(!t)continue;const r=new Date(t);(!e||r>e)&&(e=r)}return e}_relativeTime(t){const e=Math.round((Date.now()-t.getTime())/1e3);if(e<5)return"just now";if(e<60)return`${e}s ago`;const i=Math.round(e/60);if(i<60)return`${i}m ago`;const r=Math.round(i/60);if(r<24)return`${r}h ago`;return`${Math.round(r/24)}d ago`}render(){if(!this._config||!this.hass)return G;const t=this.hass.states[this._config.vacuum];if(!t)return B`<ha-card><div class="warning">Entity not found: ${this._config.vacuum}</div></ha-card>`;const e=this._config.name??t.attributes.friendly_name??"Vacuum",i=this.hass.formatEntityState?.(t)??t.state,r="bottom"===this._config.map_position?"bottom":"top",s=this._config.show_last_updated??!0?this._lastUpdated():void 0;return B`
      <ha-card>
        <div class="header" @click=${()=>this._fireMoreInfo(this._config.vacuum)}>
          ...
          <div class="header-text">
            ...
            ${s?B`<div class="last-updated">Updated ${this._relativeTime(s)}</div>`:G}
          </div>
        </div>
    ...
    `}_renderControls(t){const e="cleaning"===t.state;return B`
    ...
    `}_renderMap(){const t=this._config.camera??this._discovered.camera;if(!t)return G;const e=bt(this.hass,t);if(!e)return G;const i=this._config.map_rotation??0,r=this._roomGeometry,s=i%360!=0?`transform: rotate(${i}deg);`:"";return B`
      <div class="section map-section">
        <div class="map-wrap">
          <img class="map-image" src=${e} style=${s} @click=${this._onMapClick} />
          ${r?this._renderMapOverlay(r,s):G}
        </div>
        ${r?G:B`<div class="map-hint">
        ...
        ${this._selectedRoomIds.size>0?this._renderSelectedRoomsBar(r):G}
      </div>
    `}_renderMapOverlay(t,e){const i=Ct(this._config.room_polygons,t);return B`
      <svg
        class="map-overlay"
        style=${e}
        viewBox="0 0 ${t.image_width} ${t.image_height}"
    ...
    `}_renderRoomOverlay(t,e){const i=this._selectedRoomIds.has(t.id),r=e[String(t.id)],[s,o,n]=t.color,a=i?`rgba(${s},${o},${n},0.55)`:`rgba(${s},${o},${n},0.12)`,c=i?`rgb(${s},${o},${n})`:`rgba(${s},${o},${n},0.4)`,l=i?4:1.5,h=i?"room-shape selected":"room-shape";if(r&&r.length>=3){const t=r.map(([t,e])=>`${t},${e}`).join(" ");return W`<polygon
        ...
        stroke-width=${l}
        class=${h}
      ></polygon>`}const[d,u,p,f]=t.bbox;return W`<rect
      x=${d}
      y=${u}
      width=${p-d}
      height=${f-u}
    ...
    `}_renderFurniture(t){const e=this._config.furniture;if(!e||0===e.length)return G;const i=At(t),r=e.filter(t=>!t.map||t.map===i);if(0===r.length)return G;const s=Math.max(0,Math.min(100,this._config.furniture_opacity??100))/100,o=Ft(this._config.furniture_color),n=`--furn-fill:${o.fill};--furn-stroke:${o.stroke};--furn-detail:${o.detail};--furn-line:${o.line};`;return W`
    ...
    `}_renderSelectedRoomsBar(t){const e=[...this._selectedRoomIds].map((e,i)=>{const r=t?.rooms.find(t=>t.id===e)?.name;return r?`${i+1}. ${r}`:void 0}).filter(t=>!!t);return B`
    ...
    `}_renderSelects(){const t=this.hass.states[this._config.vacuum],e=this._config.show_fan_speed??!0,i=this._config.show_water_level??!0,r=t.attributes.fan_speed_list??[],s=t.attributes.fan_speed,o=this._config.water_level_entity??this._discovered.waterLevel,n=o?this.hass.states[o]:void 0;return e&&r.length>0||i&&n?B`
      <div class="section selects">
        ${e&&r.length>0?Nt(this.hass,"Fan speed",s??"",r.map(t=>({value:t,label:t})),t=>{t!==(s??"")&&this._setFanSpeed(t)}):G}
        ${i&&n?Nt(this.hass,"Water level",n.state,(n.attributes.options??[]).map(t=>({value:t,label:t})),t=>{t!==n.state&&this._selectOption(o,t)}):G}
      </div>
    `:G}_renderRow(t){const e=void 0!==t.percent&&!Number.isNaN(t.percent);return B`
      <div
    ...
    `}_renderBattery(){const t=this._config.battery_entity??this._discovered.battery;if(!t)return G;const e=this.hass.states[t];if(!e)return G;const i=Number(e.state);return B`
    ...
    `}_batteryIcon(t){if(Number.isNaN(t))return"mdi:battery-unknown";const e=10*Math.round(t/10);return e>=100?"mdi:battery":e<=0?"mdi:battery-outline":`mdi:battery-${e}`}_batteryColor(t){return Number.isNaN(t)?"var(--disabled-text-color)":t<=20?"var(--error-color)":t<=50?"var(--warning-color)":"var(--success-color)"}_renderMopStatus(){const t=this._config.mop_attached_entity??this._discovered.mopAttached;if(!t)return G;const e=this.hass.states[t];return e?B`
      <div class="section sensors">
    ...
    `:G}_renderSensors(){const t=this._config.sensors??this._discovered.sensors;return t&&0!==t.length?B`<div class="section sensors">${t.map(t=>this._renderSensorRow(t))}</div>`:G}_renderSensorRow(t){const e=this.hass.states[t];if(!e)return G;const i=this._shortTitle(e.attributes.friendly_name??e.entity_id);if("error"===i.toLowerCase()&&"ok"===e.state.toLowerCase())return G;const r=e.attributes.unit_of_measurement??"",s=e.attributes.icon??"mdi:information-outline",o="%"===r?Number(e.state):void 0;return this._renderRow({icon:s,title:i,value:`${e.state}${r}`,percent:void 0===o||Number.isNaN(o)?void 0:o,overdue:!!e.attributes.overdue,entityId:t})}_renderMaintenance(){const t=this._config.maintenance_sensors??this._discovered.maintenanceSensors;return t&&0!==t.length?B`
      <div class="section">
        ...
        ${this._maintenanceOpen?B`<div class="sensors">${t.map(t=>this._renderSensorRow(t))}</div>`:G}
      </div>
    `:G}_callVacuumService(t){this.hass.callService("vacuum",t,{entity_id:this._config.vacuum})}_setFanSpeed(t){t&&this.hass.callService("vacuum","set_fan_speed",{entity_id:this._config.vacuum,fan_speed:t})}_selectOption(t,e){e&&this.hass.callService("select","select_option",{entity_id:t,option:e})}_pressButton(t){this.hass.callService("button","press",{entity_id:t})}_fireMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}};Ht.styles=n`
    :host {
      display: block;
  ...
  `,t([ft({attribute:!1})],Ht.prototype,"hass",void 0),t([mt()],Ht.prototype,"_config",void 0),t([mt()],Ht.prototype,"_discovered",void 0),t([mt()],Ht.prototype,"_selectedRoomIds",void 0),t([mt()],Ht.prototype,"_maintenanceOpen",void 0),t([mt()],Ht.prototype,"_busy",void 0),t([mt()],Ht.prototype,"_trace",void 0),t([_t("img.map-image")],Ht.prototype,"_mapImg",void 0),Ht=t([dt("vacuum-card-adv")],Ht);export{Ht as VacuumCardAdv};
