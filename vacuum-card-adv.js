 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const mt=[{name:"Empty Dust Bin",icon:"mdi:delete-empty"},{name:"Wash Mop",icon:"mdi:water-sync"},{name:"Dry Mop",icon:"mdi:tumble-dryer"},{name:"Remove Hair",icon:"mdi:content-cut"}];function _t(t){return t.entities}function ft(t,e){const i=_t(t)?.[e];if(i?.name)return i.name;if(i?.original_name)return i.original_name;const s=t.states[e],o=s?.attributes?.friendly_name;return"string"==typeof o?o:e}function vt(t,e){return t.filter(t=>t.startsWith(`${e}.`))}function gt(t,e){const i=function(t,e){const i=_t(t);if(!i)return[];const s=i[e]?.device_id;return s?Object.keys(i).filter(t=>i[t]?.device_id===s):[]}(t,e),s={dockActions:[],sensors:[],maintenanceSensors:[]};if(0===i.length)return s;s.camera=vt(i,"camera")[0];for(const e of vt(i,"select")){const i=ft(t,e);i.includes("Water Level")?s.waterLevel=e:i.includes("Clean Passes")&&(s.cleanPasses=e)}for(const e of vt(i,"sensor")){const i=t.states[e];if("battery"===i?.attributes?.device_class){s.battery=e;continue}ft(t,e).toLowerCase().includes("remaining")?s.maintenanceSensors.push(e):s.sensors.push(e)}for(const e of vt(i,"binary_sensor"))ft(t,e).toLowerCase().includes("mop")&&(s.mopAttached=e);for(const e of vt(i,"button")){const i=ft(t,e),o=mt.find(t=>t.name===i);o&&s.dockActions.push({entityId:e,name:o.name,icon:o.icon})}return s}function $t(t,e,i,s){const o=i.getBoundingClientRect(),n=o.left+o.width/2,r=o.top+o.height/2,a=i.offsetWidth||o.width,c=i.offsetHeight||o.height;let l=t-n,h=e-r;if(s%360!=0){const t=-s*Math.PI/180,e=Math.cos(t),i=Math.sin(t),o=l*i+h*e;l=l*e-h*i,h=o}const d=h+c/2;return{x:(l+a/2)*(i.naturalWidth/a),y:d*(i.naturalHeight/c)}}function yt(t,e){return t.x>=e[0]&&t.x<=e[2]&&t.y>=e[1]&&t.y<=e[3]}function bt(t,e){let i=!1;for(let s=0,o=e.length-1;s<e.length;o=s++){const[n,r]=e[s],[a,c]=e[o];r>t.y!=c>t.y&&t.x<(a-n)*(t.y-r)/(c-r)+n&&(i=!i)}return i}function wt(t,e,i){const s=t.x-e,o=t.y-i;return s*s+o*o}let xt=class extends at{constructor(){super(...arguments),this._calibrationPoints=[]}setConfig(t){this._config=t}_fireConfigChanged(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_valueChanged(t,e){this._fireConfigChanged({...this._config,[t]:e})}get _cameraId(){if(this._config?.vacuum)return this._config.camera??gt(this.hass,this._config.vacuum).camera}get _roomGeometry(){const t=this._cameraId;if(!t)return;const e=this.hass.states[t]?.attributes?.room_geometry;return e&&e.rooms?.length?e:void 0}render(){return this.hass&&this._config?L`
      <div class="section">
        <ha-entity-picker
          .hass=${this.hass}
  ...
  `,t([pt({attribute:!1})],xt.prototype,"hass",void 0),t([ut()],xt.prototype,"_config",void 0),t([ut()],xt.prototype,"_calibrationRoomId",void 0),t([ut()],xt.prototype,"_calibrationPoints",void 0),xt=t([lt("vacuum-card-adv-editor")],xt),console.info("%c VACUUM-CARD-ADV %c v0.2.0 ","color: #0b0f14; background: #34e0d6; font-weight: 700;","color: #34e0d6; background: #0b0f14; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:"vacuum-card-adv",name:"TapoVac ADV Vacuum Card",description:"A card for the TapoVac-ADV integration (Tapo RV30/RV50 series).",preview:!0});let At=class extends at{constructor(){super(...arguments),this._discovered={dockActions:[],sensors:[],maintenanceSensors:[]},this._selectedRoomIds=new Set,this._maintenanceOpen=!1,this._busy=!1}static getConfigElement(){return document.createElement("vacuum-card-adv-editor")}static getStubConfig(t){return{type:"custom:vacuum-card-adv",vacuum:Object.keys(t.states).find(t=>t.startsWith("vacuum."))??"",show_map:!0,show_controls:!0,show_dock_actions:!0,show_fan_speed:!0,show_water_level:!0,show_battery:!0,show_sensors:!0,show_room_names:!0}}setConfig(t){if(!t.vacuum)throw new Error("vacuum entity is required");this._config={show_map:!0,show_controls:!0,show_dock_actions:!0,show_fan_speed:!0,show_water_level:!0,show_battery:!0,show_sensors:!0,show_room_names:!0,map_rotation:0,...t},this._maintenanceOpen=!1==!!t.maintenance_collapsed_default}getCardSize(){let t=2;return(this._config?.show_map??!0)&&(t+=6),(this._config?.show_sensors??!0)&&(t+=2),t}willUpdate(t){t.has("hass")&&this.hass&&this._config?.vacuum&&(this._lastDiscoveredFor===this._config.vacuum&&t.has("_discovered")||(this._discovered=gt(this.hass,this._config.vacuum),this._lastDiscoveredFor=this._config.vacuum))}get _roomGeometry(){const t=this._config.camera??this._discovered.camera;if(!t)return;const e=this.hass.states[t],i=e?.attributes?.room_geometry;return i&&i.rooms?i:void 0}_shortTitle(t){const e=this.hass.states[this._config.vacuum],i=e?.attributes.friendly_name;return i&&t.startsWith(`${i} `)?t.slice(i.length+1):t}render(){if(!this._config||!this.hass)return q;const t=this.hass.states[this._config.vacuum];if(!t)return L`<ha-card><div class="warning">Entity not found: ${this._config.vacuum}</div></ha-card>`;const e=this._config.name??t.attributes.friendly_name??"Vacuum",i=this.hass.formatEntityState?.(t)??t.state;return L`
    ...
    `:q}_renderRow(t){const e=void 0!==t.percent&&!Number.isNaN(t.percent);return L`
      <div class="info-row ${t.overdue?"overdue":""}">
        <ha-icon icon=${t.icon}></ha-icon>
    ...
    `}_renderBattery(){const t=this._config.battery_entity??this._discovered.battery;if(!t)return q;const e=this.hass.states[t];if(!e)return q;const i=Number(e.state);return L`
      <div class="section sensors">
        ${this._renderRow({icon:this._batteryIcon(i),title:this._shortTitle(e.attributes.friendly_name??"Battery"),value:`${e.state}%`,percent:i,gaugeColor:this._batteryColor(i)})}
      </div>
    `}_batteryIcon(t){if(Number.isNaN(t))return"mdi:battery-unknown";const e=10*Math.round(t/10);return e>=100?"mdi:battery":e<=0?"mdi:battery-outline":`mdi:battery-${e}`}_batteryColor(t){return Number.isNaN(t)?"var(--disabled-text-color)":t<=20?"var(--error-color)":t<=50?"var(--warning-color)":"var(--success-color)"}_renderSensors(){const t=this._config.sensors??this._discovered.sensors;return t&&0!==t.length?L`<div class="section sensors">${t.map(t=>this._renderSensorRow(t))}</div>`:q}_renderSensorRow(t){const e=this.hass.states[t];if(!e)return q;const i=this._shortTitle(e.attributes.friendly_name??e.entity_id),s=e.attributes.unit_of_measurement??"",o=e.attributes.icon??"mdi:information-outline",n="%"===s?Number(e.state):void 0;return this._renderRow({icon:o,title:i,value:`${e.state}${s}`,percent:void 0===n||Number.isNaN(n)?void 0:n,overdue:!!e.attributes.overdue})}_renderMaintenance(){const t=this._config.maintenance_sensors??this._discovered.maintenanceSensors;return t&&0!==t.length?L`
      <div class="section">
  ...
  `,t([pt({attribute:!1})],At.prototype,"hass",void 0),t([ut()],At.prototype,"_config",void 0),t([ut()],At.prototype,"_discovered",void 0),t([ut()],At.prototype,"_selectedRoomIds",void 0),t([ut()],At.prototype,"_maintenanceOpen",void 0),t([ut()],At.prototype,"_busy",void 0),t([
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t){return(e,i,s)=>((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(e,i,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("img.map-image")],At.prototype,"_mapImg",void 0),At=t([lt("vacuum-card-adv")],At);export{At as VacuumCardAdv};
